...
/**
 * Test for /settlementFile/{settlementId}
 */
Test('/settlementFile/{settlementId}', function (t) {
     ...
     */
    t.test('test GetSettlementFilesBySettlementID get operation', async function (t) {
